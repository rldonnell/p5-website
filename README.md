...
The v1 homepage for P5, the lead marketing and sales agency for owner-operators of high-value service businesses. Built to the locked v1 visual brief: soft white background (#FAFAF6), forest accent (#3B4E36), Fraunces + Inter typography via Google Fonts.
