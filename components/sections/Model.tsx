  ...
  return (
    ...
    >
      <div className="max-w-[68ch]">
        ...
        <h2
          id="model-heading"
          className="font-display font-normal text-ink leading-[1.1] tracking-[-0.01em] text-[32px] md:text-[40px] lg:text-[48px] mb-10"
        >
          We build the ICP. We write the plan. We measure the whole program.
        </h2>
        <div className="space-y-6 text-ink text-[17px] md:text-[19px] leading-relaxed">
          <p>
